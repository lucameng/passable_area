#ifndef PASSABLE_AREA_INTERFACES_ROS_RUNTIME_DEBUG_PUBLISHERS_HPP_
#define PASSABLE_AREA_INTERFACES_ROS_RUNTIME_DEBUG_PUBLISHERS_HPP_
...
private:
  ...
  rclcpp::Publisher<passable_area::msg::TerrainObservability>::SharedPtr
      observability_pub_;
};
