...
inline double rangedRadian(double radian, double radian_min,
                           double radian_max) {
...
inline double rangedDegree(double degree, double degree_min,
                           double degree_max) {
  // BAY_ASSERT("robotctl",degree_max > degree_min && degree_max - degree_min ==
  // 360);
