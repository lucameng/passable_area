...
using passable_area::core::OdomPointSample;
...
TEST(ProcessorTest, PolarFrontendKeepsRealObstacleWhenUpperZIsSlightlyPositive) {
  auto config = MakeConfig();
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  config.geometry.min_neighbor_upper_support_cells = 2;
  ...
  int front_right_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.35f, front_left_cell));
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.35f, front_center_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.35f, front_right_cell));
  map.layers().support_height[static_cast<size_t>(primary_cell)] = -0.20f;
  map.layers().support_confidence[static_cast<size_t>(primary_cell)] = 0.6f;
  map.layers().support_state[static_cast<size_t>(primary_cell)] =
      static_cast<uint8_t>(SupportState::kPersistent);
  map.layers().last_reliable_age[static_cast<size_t>(primary_cell)] = 0U;

  map.layers().support_height[static_cast<size_t>(front_left_cell)] = -0.40f;
  map.layers().support_confidence[static_cast<size_t>(front_left_cell)] = 0.6f;
  map.layers().support_state[static_cast<size_t>(front_left_cell)] = static_cast<uint8_t>(SupportState::kPersistent);
  map.layers().last_reliable_age[static_cast<size_t>(front_left_cell)] = 0U;

  map.layers().support_height[static_cast<size_t>(front_center_cell)] = -0.40f;
  map.layers().support_confidence[static_cast<size_t>(front_center_cell)] = 0.6f;
  map.layers().support_state[static_cast<size_t>(front_center_cell)] = static_cast<uint8_t>(SupportState::kPersistent);
  map.layers().last_reliable_age[static_cast<size_t>(front_center_cell)] = 0U;

  map.layers().support_height[static_cast<size_t>(front_right_cell)] = -0.40f;
  map.layers().support_confidence[static_cast<size_t>(front_right_cell)] = 0.6f;
  map.layers().support_state[static_cast<size_t>(front_right_cell)] = static_cast<uint8_t>(SupportState::kPersistent);
  map.layers().last_reliable_age[static_cast<size_t>(front_right_cell)] = 0U;

  const auto frame = MakeProcessedFrame({
      {{0.25f, 0.25f, -0.20f}, {0.25f, 0.25f, -0.20f}},
      {{0.25f, 0.25f, -0.19f}, {0.25f, 0.25f, -0.19f}},
      {{0.25f, 0.25f, 0.03f}, {0.25f, 0.25f, 0.03f}},
      {{0.25f, 0.25f, 0.04f}, {0.25f, 0.25f, 0.04f}},
      {{0.15f, 0.35f, -0.40f}, {0.15f, 0.35f, -0.40f}},
      {{0.15f, 0.35f, -0.38f}, {0.15f, 0.35f, -0.38f}},
      {{0.15f, 0.35f, -0.15f}, {0.15f, 0.35f, -0.15f}},
      {{0.15f, 0.35f, -0.14f}, {0.15f, 0.35f, -0.14f}},
      {{0.25f, 0.35f, -0.40f}, {0.25f, 0.35f, -0.40f}},
      {{0.25f, 0.35f, -0.38f}, {0.25f, 0.35f, -0.38f}},
      {{0.25f, 0.35f, -0.15f}, {0.25f, 0.35f, -0.15f}},
      {{0.25f, 0.35f, -0.14f}, {0.25f, 0.35f, -0.14f}},
      {{0.35f, 0.35f, -0.40f}, {0.35f, 0.35f, -0.40f}},
      {{0.35f, 0.35f, -0.38f}, {0.35f, 0.35f, -0.38f}},
      {{0.35f, 0.35f, -0.15f}, {0.35f, 0.35f, -0.15f}},
      {{0.35f, 0.35f, -0.14f}, {0.35f, 0.35f, -0.14f}},
  });

  const auto output = frontend.run(frame, observability, map);

  EXPECT_FLOAT_EQ(output.support_anchor_used[static_cast<size_t>(primary_cell)], -0.20f);
  EXPECT_EQ(output.sub_support_leak_count[static_cast<size_t>(primary_cell)], 0U);
  EXPECT_EQ(output.upper_support_cell[static_cast<size_t>(primary_cell)], 1U);
  EXPECT_EQ(output.obstacle_rejected_by_neighbor_support[static_cast<size_t>(primary_cell)], 0U);
  const auto primary_cell_candidate_count =
...
TEST(ProcessorTest, PolarFrontendKeepsBelowRobotObstacleOnUpstairSupportTrend) {
  ...
  int right_up_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.35f, left_up_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.35f, right_up_cell));

  const auto frame = MakeProcessedFrame({
      {{0.25f, 0.25f, -0.72f}, {0.25f, 0.25f, -0.72f}},
      {{0.25f, 0.25f, -0.69f}, {0.25f, 0.25f, -0.69f}},
      {{0.25f, 0.25f, -0.06f}, {0.25f, 0.25f, -0.06f}},
      {{0.15f, 0.35f, -0.52f}, {0.15f, 0.35f, -0.52f}},
      {{0.15f, 0.35f, -0.31f}, {0.15f, 0.35f, -0.31f}},
      {{0.35f, 0.35f, -0.50f}, {0.35f, 0.35f, -0.50f}},
      {{0.35f, 0.35f, -0.29f}, {0.35f, 0.35f, -0.29f}},
  });
...
TEST(ProcessorTest, PolarFrontendUsesElevatedEffectiveSupportRefForLayeredGroundWithWeakUpperStructure) {
  ...
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, left_neighbor));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, right_neighbor));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.35f, diagonal_neighbor));
  ...
  const auto frame = MakeProcessedFrame({
      ...
      {{0.25f, 0.25f, -0.55f}, {0.25f, 0.25f, -0.55f}},
      {{0.15f, 0.25f, -0.74f}, {0.15f, 0.25f, -0.74f}},
      {{0.15f, 0.25f, -0.72f}, {0.15f, 0.25f, -0.72f}},
      {{0.35f, 0.25f, -0.73f}, {0.35f, 0.25f, -0.73f}},
      {{0.35f, 0.25f, -0.71f}, {0.35f, 0.25f, -0.71f}},
  });
...
TEST(ProcessorTest, PolarFrontendKeepsLowObstacleWhenUpperLayerLacksNeighborSupportConsistency) {
  ...
  int right_neighbor = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(-0.35f, 0.25f, left_neighbor));
  ASSERT_TRUE(map.odomToIndex(0.85f, 0.25f, right_neighbor));
  map.layers().support_height[static_cast<size_t>(primary_cell)] = -0.82f;
  map.layers().support_confidence[static_cast<size_t>(primary_cell)] = 0.6f;
  map.layers().support_state[static_cast<size_t>(primary_cell)] =
      static_cast<uint8_t>(SupportState::kPersistent);
...
TEST(ProcessorTest, PolarFrontendUsesElevatedEffectiveSupportRefForUnanchoredLayeredStair) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int upper_forward = -1;
  int upper_left = -1;
  int upper_forward_left = -1;
  int lower_back = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, upper_forward));
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.35f, upper_left));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.35f, upper_forward_left));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, lower_back));

  const auto frame = MakeProcessedFrame({
      {{0.25f, 0.25f, -0.92f}, {0.25f, 0.25f, -0.92f}},
      {{0.25f, 0.25f, -0.90f}, {0.25f, 0.25f, -0.90f}},
      {{0.25f, 0.25f, -0.57f}, {0.25f, 0.25f, -0.57f}},
      {{0.25f, 0.25f, -0.56f}, {0.25f, 0.25f, -0.56f}},
      {{0.35f, 0.25f, -0.92f}, {0.35f, 0.25f, -0.92f}},
      {{0.35f, 0.25f, -0.90f}, {0.35f, 0.25f, -0.90f}},
      {{0.35f, 0.25f, -0.57f}, {0.35f, 0.25f, -0.57f}},
      {{0.35f, 0.25f, -0.56f}, {0.35f, 0.25f, -0.56f}},
      {{0.25f, 0.35f, -0.92f}, {0.25f, 0.35f, -0.92f}},
      {{0.25f, 0.35f, -0.90f}, {0.25f, 0.35f, -0.90f}},
      {{0.25f, 0.35f, -0.57f}, {0.25f, 0.35f, -0.57f}},
      {{0.25f, 0.35f, -0.56f}, {0.25f, 0.35f, -0.56f}},
      {{0.35f, 0.35f, -0.92f}, {0.35f, 0.35f, -0.92f}},
      {{0.35f, 0.35f, -0.90f}, {0.35f, 0.35f, -0.90f}},
      {{0.35f, 0.35f, -0.57f}, {0.35f, 0.35f, -0.57f}},
      {{0.35f, 0.35f, -0.56f}, {0.35f, 0.35f, -0.56f}},
      {{0.15f, 0.25f, -0.92f}, {0.15f, 0.25f, -0.92f}},
      {{0.15f, 0.25f, -0.90f}, {0.15f, 0.25f, -0.90f}},
  });
...
TEST(ProcessorTest,
     PolarFrontendUsesElevatedEffectiveSupportRefForUnanchoredLayeredStairRunWithoutAnchorBands) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int lower_back = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, upper_a));
  ASSERT_TRUE(map.odomToIndex(0.45f, 0.25f, upper_b));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.35f, upper_c));
  ASSERT_TRUE(map.odomToIndex(0.45f, 0.35f, upper_d));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, lower_back));
  ...
  const auto frame = MakeProcessedFrame({
      ...
      {{0.35f, 0.25f, -0.57f}, {0.35f, 0.25f, -0.57f}},
      {{0.35f, 0.25f, -0.56f}, {0.35f, 0.25f, -0.56f}},
      {{0.45f, 0.25f, -0.92f}, {0.45f, 0.25f, -0.92f}},
      {{0.45f, 0.25f, -0.90f}, {0.45f, 0.25f, -0.90f}},
      {{0.45f, 0.25f, -0.57f}, {0.45f, 0.25f, -0.57f}},
      {{0.45f, 0.25f, -0.56f}, {0.45f, 0.25f, -0.56f}},
      {{0.35f, 0.35f, -0.92f}, {0.35f, 0.35f, -0.92f}},
      {{0.35f, 0.35f, -0.90f}, {0.35f, 0.35f, -0.90f}},
      {{0.35f, 0.35f, -0.57f}, {0.35f, 0.35f, -0.57f}},
      {{0.35f, 0.35f, -0.56f}, {0.35f, 0.35f, -0.56f}},
      {{0.45f, 0.35f, -0.92f}, {0.45f, 0.35f, -0.92f}},
      {{0.45f, 0.35f, -0.90f}, {0.45f, 0.35f, -0.90f}},
      {{0.45f, 0.35f, -0.57f}, {0.45f, 0.35f, -0.57f}},
      {{0.45f, 0.35f, -0.56f}, {0.45f, 0.35f, -0.56f}},
      {{0.15f, 0.25f, -0.92f}, {0.15f, 0.25f, -0.92f}},
      {{0.15f, 0.25f, -0.90f}, {0.15f, 0.25f, -0.90f}},
  });
...
TEST(ProcessorTest, PolarFrontendKeepsUnanchoredLowObstacleWithoutNeighborAnchorConsistency) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  int upper_neighbor = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, upper_neighbor));

  const auto frame = MakeProcessedFrame({
      {{0.25f, 0.25f, -0.84f}, {0.25f, 0.25f, -0.84f}},
      {{0.25f, 0.25f, -0.82f}, {0.25f, 0.25f, -0.82f}},
      {{0.25f, 0.25f, -0.56f}, {0.25f, 0.25f, -0.56f}},
      {{0.25f, 0.25f, -0.55f}, {0.25f, 0.25f, -0.55f}},
      {{0.25f, 0.25f, -0.28f}, {0.25f, 0.25f, -0.28f}},
      {{0.35f, 0.25f, -0.84f}, {0.35f, 0.25f, -0.84f}},
      {{0.35f, 0.25f, -0.82f}, {0.35f, 0.25f, -0.82f}},
      {{0.35f, 0.25f, -0.30f}, {0.35f, 0.25f, -0.30f}},
  });
...
TEST(ProcessorTest, PolarFrontendKeepsUnanchoredWallEdgeLayeredStructure) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int lower_back = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.35f, left_neighbor));
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.45f, right_neighbor));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, lower_back));
  ...
  const auto frame = MakeProcessedFrame({
      ...
      {{0.25f, 0.35f, -0.57f}, {0.25f, 0.35f, -0.57f}},
      {{0.25f, 0.35f, -0.56f}, {0.25f, 0.35f, -0.56f}},
      {{0.25f, 0.45f, -0.92f}, {0.25f, 0.45f, -0.92f}},
      {{0.25f, 0.45f, -0.90f}, {0.25f, 0.45f, -0.90f}},
      {{0.25f, 0.45f, -0.57f}, {0.25f, 0.45f, -0.57f}},
      {{0.25f, 0.45f, -0.56f}, {0.25f, 0.45f, -0.56f}},
      {{0.15f, 0.25f, -0.92f}, {0.15f, 0.25f, -0.92f}},
      {{0.15f, 0.25f, -0.90f}, {0.15f, 0.25f, -0.90f}},
      {{0.35f, 0.25f, -0.30f}, {0.35f, 0.25f, -0.30f}},
  });
...
TEST(ProcessorTest, PolarFrontendKeepsUnanchoredLayeredFacadeRun) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  int upper_forward = -1;
  int upper_forward_far = -1;
  int upper_side = -1;
  int lower_back = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, upper_forward));
  ASSERT_TRUE(map.odomToIndex(0.45f, 0.25f, upper_forward_far));
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.35f, upper_side));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, lower_back));
  ...
  const auto frame = MakeProcessedFrame({
      ...
      {{0.45f, 0.25f, -0.57f}, {0.45f, 0.25f, -0.57f}},
      {{0.45f, 0.25f, -0.56f}, {0.45f, 0.25f, -0.56f}},
      {{0.25f, 0.35f, -0.30f}, {0.25f, 0.35f, -0.30f}},
      {{0.15f, 0.25f, -0.84f}, {0.15f, 0.25f, -0.84f}},
      {{0.15f, 0.25f, -0.82f}, {0.15f, 0.25f, -0.82f}},
  });
...
TEST(ProcessorTest, PolarFrontendKeepsUnanchoredLowObstacleWithBackgroundUpperLayer) {
  auto config = MakeConfig();
  config.map.resolution = 0.1f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  int lower_back = -1;
  int background_upper = -1;
  int upper_neighbor = -1;
  ASSERT_TRUE(map.odomToIndex(0.25f, 0.25f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.15f, 0.25f, lower_back));
  ASSERT_TRUE(map.odomToIndex(0.45f, 0.45f, background_upper));
  ASSERT_TRUE(map.odomToIndex(0.35f, 0.25f, upper_neighbor));
  ...
  const auto frame = MakeProcessedFrame({
      ...
      {{0.25f, 0.25f, -0.60f}, {0.25f, 0.25f, -0.60f}},
      {{0.25f, 0.25f, -0.58f}, {0.25f, 0.25f, -0.58f}},
      {{0.25f, 0.25f, -0.18f}, {0.25f, 0.25f, -0.18f}},
      {{0.15f, 0.25f, -0.84f}, {0.15f, 0.25f, -0.84f}},
      {{0.15f, 0.25f, -0.82f}, {0.15f, 0.25f, -0.82f}},
      {{0.35f, 0.25f, -0.84f}, {0.35f, 0.25f, -0.84f}},
      {{0.35f, 0.25f, -0.82f}, {0.35f, 0.25f, -0.82f}},
      {{0.35f, 0.25f, -0.31f}, {0.35f, 0.25f, -0.31f}},
      {{0.45f, 0.45f, -0.59f}, {0.45f, 0.45f, -0.59f}},
      {{0.45f, 0.45f, -0.57f}, {0.45f, 0.45f, -0.57f}},
  });
...
TEST(ProcessorTest, PolarFrontendExtendsToUnanchoredLayeredStairRunEdgeNextToStrictInterior) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  config.geometry.min_neighbor_upper_support_cells = 2;
  PolarFrontend frontend(config);
  ...
  int primary_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, primary_cell));

  std::vector<OdomPointSample> samples;
  const auto addLayeredCell = [&samples](float x, float y, float lower_z, float upper_z) {
    samples.push_back({{x, y, lower_z}, {x, y, lower_z}});
    samples.push_back({{x, y, lower_z + 0.02f}, {x, y, lower_z + 0.02f}});
    samples.push_back({{x, y, upper_z}, {x, y, upper_z}});
    samples.push_back({{x, y, upper_z + 0.01f}, {x, y, upper_z + 0.01f}});
  };
  const auto addLayeredCellAt = [&map, &addLayeredCell](int cell, float lower_z, float upper_z) {
    const Eigen::Vector2f center = map.indexToOdom(cell);
    addLayeredCell(center.x(), center.y(), lower_z, upper_z);
  };

  std::vector<int> edge_cells;
  std::vector<int> interior_cells;
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    int edge_cell = -1;
    int cell_48 = -1;
    int cell_56 = -1;
    int cell_64 = -1;
    ASSERT_TRUE(map.odomToIndex(0.40f, y, edge_cell));
    ASSERT_TRUE(map.odomToIndex(0.48f, y, cell_48));
    ASSERT_TRUE(map.odomToIndex(0.56f, y, cell_56));
    ASSERT_TRUE(map.odomToIndex(0.64f, y, cell_64));
    edge_cells.push_back(edge_cell);
    interior_cells.push_back(cell_48);
    interior_cells.push_back(cell_56);
    interior_cells.push_back(cell_64);
  }
  int back_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.32f, 0.24f, back_cell));

  for (const int cell : interior_cells) {
    addLayeredCellAt(cell, -0.92f, -0.57f);
  }
  for (const int cell : edge_cells) {
    addLayeredCellAt(cell, -0.92f, -0.57f);
  }
  addLayeredCellAt(back_cell, -0.92f, -0.57f);

  const auto output = frontend.run(MakeProcessedFrame(samples), observability, map);

  EXPECT_TRUE(std::isnan(output.support_anchor_used[static_cast<size_t>(primary_cell)]));
  EXPECT_EQ(output.effective_support_ref_elevated[static_cast<size_t>(primary_cell)], 1U);
  EXPECT_EQ(output.upper_support_cell[static_cast<size_t>(primary_cell)], 0U);
  const auto primary_cell_candidate_count =
      std::count_if(output.obstacle_candidates.begin(), output.obstacle_candidates.end(),
                    [primary_cell](const auto &candidate) {
...
TEST(ProcessorTest, PolarFrontendKeepsWeakLayeredEdgeWithoutAdjacentStrictInterior) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.56f, 0.24f, primary_cell));
  ...
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    addLayeredCell(0.56f, y, -0.92f, -0.57f);
    addLayeredCell(0.64f, y, -0.92f, -0.57f);
  }

  const auto output = frontend.run(MakeProcessedFrame(samples), observability, map);

  EXPECT_TRUE(std::isnan(output.support_anchor_used[static_cast<size_t>(primary_cell)]));
  EXPECT_EQ(output.effective_support_ref_elevated[static_cast<size_t>(primary_cell)], 0U);
  EXPECT_EQ(output.upper_support_cell[static_cast<size_t>(primary_cell)], 1U);
}

TEST(ProcessorTest, PolarFrontendKeepsLayeredWallEdgeNearStrictInteriorBoundary) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.56f, 0.40f, primary_cell));
  ...
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    ...
    ASSERT_TRUE(map.odomToIndex(0.56f, y, cell_56));
    ASSERT_TRUE(map.odomToIndex(0.64f, y, cell_64));
    addLayeredCellAt(cell_48, -0.92f, -0.57f);
    addLayeredCellAt(cell_56, -0.92f, -0.57f);
    addLayeredCellAt(cell_64, -0.92f, -0.57f);
  }
  int back_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, back_cell));
  addLayeredCellAt(back_cell, -0.92f, -0.57f);
  const Eigen::Vector2f primary_center = map.indexToOdom(primary_cell);
  samples.push_back({{primary_center.x(), primary_center.y(), -0.80f},
                     {primary_center.x(), primary_center.y(), -0.80f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.78f},
                     {primary_center.x(), primary_center.y(), -0.78f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.57f},
                     {primary_center.x(), primary_center.y(), -0.57f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.46f},
                     {primary_center.x(), primary_center.y(), -0.46f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.35f},
                     {primary_center.x(), primary_center.y(), -0.35f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.24f},
                     {primary_center.x(), primary_center.y(), -0.24f}});

  auto frame = MakeProcessedFrame(samples);
  frame.base_pose_in_odom.position.z() = 0.05f;
  const auto output = frontend.run(frame, observability, map);
...
TEST(ProcessorTest, PolarFrontendLeavesNotBelowRobotResidualGeometryUntouched) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.24f, primary_cell));
  ...
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    ...
    ASSERT_TRUE(map.odomToIndex(0.56f, y, cell_56));
    ASSERT_TRUE(map.odomToIndex(0.64f, y, cell_64));
    ASSERT_TRUE(map.odomToIndex(0.72f, y, cell_72));
    ASSERT_TRUE(map.odomToIndex(0.80f, y, cell_80));
    addLayeredCellAt(cell_48, -0.92f, -0.57f);
    addLayeredCellAt(cell_56, -0.92f, -0.57f);
    addLayeredCellAt(cell_64, -0.92f, -0.57f);
    addLayeredCellAt(cell_72, -0.92f, -0.57f);
    addLayeredCellAt(cell_80, -0.92f, -0.57f);
  }
  int back_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, back_cell));
  addLayeredCellAt(back_cell, -0.92f, -0.57f);
  ...
  samples.push_back({{primary_center.x(), primary_center.y(), -0.24f},
                     {primary_center.x(), primary_center.y(), -0.24f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.22f},
                     {primary_center.x(), primary_center.y(), -0.22f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.19f},
                     {primary_center.x(), primary_center.y(), 0.19f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.20f},
                     {primary_center.x(), primary_center.y(), 0.20f}});
...
TEST(ProcessorTest, PolarFrontendExtendsToUnanchoredLayeredStairRunFrontEdgeNextToValidatedEdge) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.80f, 0.24f, primary_cell));
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    int cell_48 = -1;
    int cell_56 = -1;
    int cell_64 = -1;
    ...
    ASSERT_TRUE(map.odomToIndex(0.72f, y, cell_72));
    ASSERT_TRUE(map.odomToIndex(0.80f, y, cell_80));
    addLayeredCellAt(cell_48, -0.26f, 0.04f);
    addLayeredCellAt(cell_56, -0.26f, 0.04f);
    addLayeredCellAt(cell_64, -0.26f, 0.04f);
    addLayeredCellAt(cell_72, -0.26f, 0.04f);
    addLayeredCellAt(cell_80, -0.26f, 0.06f);
  }
  int back_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, back_cell));
  addLayeredCellAt(back_cell, -0.26f, 0.04f);
...
TEST(ProcessorTest,
     PolarFrontendExtendsToUnanchoredLayeredStairRunFrontEdgeNextToElevatedEdgePatch) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int primary_cell = -1;
  int adjacent_edge_patch_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.24f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.16f, adjacent_edge_patch_cell));
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    int cell_48 = -1;
    int cell_56 = -1;
    int cell_64 = -1;
  ...
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, back_cell));
  addLayeredCellAt(back_cell, -0.26f, 0.04f);
  addLayeredCellAt(adjacent_edge_patch_cell, -0.26f, 0.06f);
  addLayeredCellAt(primary_cell, -0.26f, 0.06f);
...
TEST(ProcessorTest, PolarFrontendRejectsBelowRobotUpstairGroundMixWithSlightPositiveUpperZ) {
  auto config = MakeConfig();
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  config.geometry.min_neighbor_upper_support_cells = 2;
  ...
  const auto frame = MakeProcessedFrame({
      {{0.25f, 0.25f, -0.26f}, {0.25f, 0.25f, -0.26f}},
      {{0.25f, 0.25f, -0.24f}, {0.25f, 0.25f, -0.24f}},
      {{0.25f, 0.25f, 0.03f}, {0.25f, 0.25f, 0.03f}},
      {{0.15f, 0.35f, -0.12f}, {0.15f, 0.35f, -0.12f}},
      {{0.15f, 0.35f, -0.10f}, {0.15f, 0.35f, -0.10f}},
      {{0.25f, 0.35f, -0.12f}, {0.25f, 0.35f, -0.12f}},
      {{0.25f, 0.35f, -0.10f}, {0.25f, 0.35f, -0.10f}},
      {{0.35f, 0.35f, -0.11f}, {0.35f, 0.35f, -0.11f}},
      {{0.35f, 0.35f, -0.09f}, {0.35f, 0.35f, -0.09f}},
  });
  const auto output = frontend.run(frame, observability, map);
...
TEST(ProcessorTest,
     PolarFrontendExtendsToAnchoredLayeredStairRunFrontEdgeNextToValidatedPatch) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  const auto setAnchoredSupport = [&map](int cell, float z) {
    map.layers().support_height[static_cast<size_t>(cell)] = z;
    map.layers().support_confidence[static_cast<size_t>(cell)] = 0.6f;
    map.layers().support_state[static_cast<size_t>(cell)] =
        static_cast<uint8_t>(SupportState::kPersistent);
    map.layers().last_reliable_age[static_cast<size_t>(cell)] = 0U;
  ...
  int anchor_right = -1;
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.24f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.16f, anchor_left));
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.32f, anchor_right));
  ...
  for (const float y : {0.16f, 0.24f, 0.32f}) {
    ...
    addLayeredCellAt(cell_64, -0.26f, 0.04f);
    addLayeredCellAt(cell_72, -0.26f, 0.04f);
    addLayeredCellAt(cell_80, -0.26f, 0.04f);
  }
  int back_cell = -1;
  ASSERT_TRUE(map.odomToIndex(0.40f, 0.24f, back_cell));
  addLayeredCellAt(back_cell, -0.26f, 0.04f);

  setAnchoredSupport(primary_cell, -0.26f);
  setAnchoredSupport(anchor_left, -0.26f);
  setAnchoredSupport(anchor_right, -0.26f);
  addLayeredCellAt(primary_cell, -0.26f, 0.04f);
  addLayeredCellAt(anchor_left, -0.26f, 0.04f);
  addLayeredCellAt(anchor_right, -0.26f, 0.04f);

  auto frame = MakeProcessedFrame(samples);
  frame.base_pose_in_odom.position.z() = 0.05f;
  const auto output = frontend.run(frame, observability, map);

  EXPECT_TRUE(std::isfinite(output.support_anchor_used[static_cast<size_t>(primary_cell)]));
  EXPECT_EQ(output.effective_support_ref_elevated[static_cast<size_t>(primary_cell)], 1U);
  EXPECT_EQ(output.upper_support_cell[static_cast<size_t>(primary_cell)], 0U);
  EXPECT_EQ(output.obstacle_rejected_by_neighbor_support[static_cast<size_t>(primary_cell)], 1U);
  const auto primary_cell_candidate_count =
...
TEST(ProcessorTest,
     PolarFrontendKeepsAnchoredLayeredFrontEdgeObstacleWithoutAdjacentValidatedPatch) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
...
TEST(ProcessorTest, PolarFrontendKeepsAnchoredWallEdgeFrontResidualNearValidatedPatch) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  int anchor_left = -1;
  int anchor_right = -1;
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.40f, primary_cell));
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.32f, anchor_left));
  ASSERT_TRUE(map.odomToIndex(0.88f, 0.48f, anchor_right));
  ...
  addLayeredCellAt(anchor_right, -0.26f, 0.04f);
  const Eigen::Vector2f primary_center = map.indexToOdom(primary_cell);
  samples.push_back({{primary_center.x(), primary_center.y(), -0.26f},
                     {primary_center.x(), primary_center.y(), -0.26f}});
  samples.push_back({{primary_center.x(), primary_center.y(), -0.24f},
                     {primary_center.x(), primary_center.y(), -0.24f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.04f},
                     {primary_center.x(), primary_center.y(), 0.04f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.16f},
                     {primary_center.x(), primary_center.y(), 0.16f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.28f},
                     {primary_center.x(), primary_center.y(), 0.28f}});
  samples.push_back({{primary_center.x(), primary_center.y(), 0.40f},
                     {primary_center.x(), primary_center.y(), 0.40f}});
...
TEST(ProcessorTest, PolarFrontendLeavesAnchoredFrontResidualNotBelowRobotGeometryUntouched) {
  auto config = MakeConfig();
  config.map.resolution = 0.08f;
  config.geometry.upper_min_height_above_support = 0.2f;
  config.geometry.max_step_up = 0.28f;
  ...
  setAnchoredSupport(anchor_left, -0.26f);
  setAnchoredSupport(anchor_right, -0.26f);
  addLayeredCellAt(primary_cell, -0.26f, 0.20f);
  addLayeredCellAt(anchor_left, -0.26f, 0.20f);
  addLayeredCellAt(anchor_right, -0.26f, 0.20f);
...
TEST(ProcessorTest, ReinterpretedCellClearsResidualObstacleLayerImmediately) {
  auto config = MakeConfig();
  config.map.length = 2.0f;
  config.map.width = 2.0f;
  config.map.resolution = 1.0f;
  ...
  map.layers().support_confidence[3] = 0.8f;
  map.layers().support_state[3] = static_cast<uint8_t>(SupportState::kPersistent);
  map.layers().obstacle_evidence[3] = 0.9f;
  map.layers().overhead_height[3] = 0.32f;
  map.layers().overhead_confidence[3] = 0.9f;

  FrontendOutput frontend_output;
  frontend_output.support_candidates.push_back(SupportCandidate{3, 0.0f, 1.0f});
  frontend_output.effective_support_ref_elevated.assign(static_cast<size_t>(map.size()), 0U);
  frontend_output.obstacle_candidate_cell.assign(static_cast<size_t>(map.size()), 0U);
  frontend_output.effective_support_ref_elevated[3] = 1U;

  const auto dirty = updater.update(frontend_output, observability, map);

  ASSERT_FALSE(dirty.empty());
  EXPECT_FLOAT_EQ(map.layers().obstacle_evidence[3], 0.0f);
  EXPECT_TRUE(std::isnan(map.layers().overhead_height[3]));
  EXPECT_FLOAT_EQ(map.layers().overhead_confidence[3], 0.0f);
}

TEST(ProcessorTest, RejectedCurrentCellClearsResidualObstacleLayerImmediately) {
  auto config = MakeConfig();
  config.map.length = 2.0f;
  config.map.width = 2.0f;
  config.map.resolution = 1.0f;
  ...
  frontend_output.effective_support_ref_elevated.assign(static_cast<size_t>(map.size()), 0U);
  frontend_output.obstacle_candidate_cell.assign(static_cast<size_t>(map.size()), 0U);
  frontend_output.obstacle_rejected_by_neighbor_support.assign(static_cast<size_t>(map.size()), 0U);
  frontend_output.obstacle_rejected_by_neighbor_support[3] = 1U;
