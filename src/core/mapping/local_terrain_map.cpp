...
template <typename T>
void ShiftLayer(std::vector<T> &values, int rows, int cols, int row_shift, int col_shift,
                const T &fill_value) {
...
void LocalTerrainMap::shiftLayers(int row_shift, int col_shift) {
  ...
  ShiftLayer(layers_.support_confidence, rows_, cols_, row_shift, col_shift, 0.0f);
  ShiftLayer(layers_.overhead_height, rows_, cols_, row_shift, col_shift,
             std::numeric_limits<float>::quiet_NaN());
  ShiftLayer(layers_.overhead_confidence, rows_, cols_, row_shift, col_shift, 0.0f);
  ShiftLayer(layers_.obstacle_evidence, rows_, cols_, row_shift, col_shift, 0.0f);
  ShiftLayer(layers_.coverage_confidence, rows_, cols_, row_shift, col_shift, 0.0f);
  ...
  ShiftLayer(layers_.clearance, rows_, cols_, row_shift, col_shift,
             std::numeric_limits<float>::quiet_NaN());
  ShiftLayer(layers_.support_continuity, rows_, cols_, row_shift, col_shift, 0.0f);
  ...
  ShiftLayer(layers_.traversal_cost, rows_, cols_, row_shift, col_shift, static_cast<int8_t>(-1));
  ...
  ShiftLayer(layers_.last_observed_age, rows_, cols_, row_shift, col_shift, static_cast<uint16_t>(0));
